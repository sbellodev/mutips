document.addEventListener('DOMContentLoaded', () => {
    const characterInfo = {
        name: "Incineroar",
        category:"offensive", description: "Incineroar is a powerful grappler with strong throws and revenge mechanics.",
        matchups: [
            { opponent: "Mario", category:"offensive", description: "Ban tri-plats. Other than that, you should be <b>revenging</b> carelessly thrown <b>fireballs</b>, using <b>fair and nair to trade or wall</b>, and using <b>dariat</b> generously <b>to keep him off you</b> (but be careful if he starts whiff punishing it). Make sure to DI away from platforms to limit extensions.", image: "./img/characters/mario.png" },
            ...
            { opponent: "Fox", category:"offensive", description: "This mu is dariat central. Mash this move like crazy, as even if you get punished for it, it’s around a normal fox punish (unless you’re at kill %, when is which you can use shield generously). This is just another mu where every trade you get is excellent, and taking risks can pay off splendidly because the risk-reward is very skewed in your favor. You can eat some punishes.", image: "./img/characters/fox.png" },
            { opponent: "Pikachu", category:"offensive", description: "Any thunder jolts that aren’t attended to by pika can be revenged. Dariat can also punish a lot of quick attacks if pika ends up near you after hitting you. Otherwise, just make sure you know all your recovery mixups and try to calculate risk-reward for strong kill moves often throughout a match. Once you take a lead, you’re in a much better position to turtle, space with fair, and compound said lead.", image: "./img/characters/pikachu.png" },
            { opponent: "Luigi", category:"offensive", description: "Just don’t get grabbed. Platform camp, land on him with spaced nairs or punish commitments with nairs to start combos. Just completely focus on getting a lead and camping him if you can.", image: "./img/characters/luigi.png" },
